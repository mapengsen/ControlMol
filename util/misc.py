...
def save_model_best (args ,epoch ,model ,model_without_ddp ,optimizer ,loss_scaler ,ema_params =None ):
    output_dir =Path (args .output_dir )
    epoch_name ='best'
    if loss_scaler is not None :
        checkpoint_paths =[output_dir /('checkpoint-%s.pth'%epoch_name )]
...
def load_model (args ,model_without_ddp ,optimizer ,loss_scaler ):
    ...
    if args .resume :
        ...
        # FilterCount(TrainingrepImageGenerateModel)
        filtered_state_dict ={}
